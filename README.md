...
Todas as camadas da aplicação (Models, Service e Controllers) foram desenvolvidas.
...
- `git clone git@github.com:mariananogueirab/Project-Cookmaster-Trybe-BackEnd.git`.
- Entre na pasta do repositório que você acabou de clonar:
  - `cd Project-Cookmaster-Trybe-BackEnd`
...
O banco tem duas coleções: users e recipes.
